  ...
  <div class="app-container">
    <div class="search-bar">
      <el-form ref="queryFormRef" :model="queryParams" :inline="true">
        ...
        <el-form-item label="家庭组状态" prop="status">
    ...
    <el-card shadow="never">
      ...
      >
        ...
        <el-table-column prop="name" label="家庭组名称" min-width="200" />
        <el-table-column prop="code" label="家庭组编号" width="200" />
    ...
    >
      <el-form ref="deptFormRef" :model="formData" :rules="rules" label-width="80px">
        <el-form-item label="上级家庭组" prop="parentId">
          <el-tree-select
        ...
        <el-form-item label="家庭组名称" prop="name">
          <el-input v-model="formData.name" placeholder="请输入家庭组名称" />
        </el-form-item>
        <el-form-item label="家庭组编号" prop="code">
          <el-input v-model="formData.code" placeholder="请输入家庭组编号" />
        </el-form-item>
...
const rules = reactive({
  parentId: [{ required: true, message: "上级家庭组不能为空", trigger: "change" }],
  name: [{ required: true, message: "家庭组名称不能为空", trigger: "blur" }],
  code: [{ required: true, message: "家庭组编号不能为空", trigger: "blur" }],
